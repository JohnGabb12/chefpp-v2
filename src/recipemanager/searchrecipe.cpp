...
/*
    ...
    How it works:
        - User selects search type (by name or by ingredients)
        - Enters search query
        ...
        - Options: Research (search again) or Back
    ...
    SearchRecipePage:
        private:
            ...
            - lastSearchType        : Stores the last search type (1=name, 2=ingredients)
